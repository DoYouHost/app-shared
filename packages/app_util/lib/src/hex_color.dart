...
/// without a trailing alpha (`RRGGBBAA`).
...
/// Squared RGB distance between two hex colours — the largest finite double
/// when either is missing, so a known colour always beats an unknown one when
