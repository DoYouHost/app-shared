...
/// a background isolate needs, its heap dying with the service.
///
...
class LogFileSink {
  ...
  ///
  /// These suffixes are names on the user's disk, not just wire values: an app
  /// updated mid-recording has to find the file the previous build wrote. So
  /// each is the spelling that build already used, and none of them is up for
  /// tidying.
