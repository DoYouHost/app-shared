...
/// Stands in for whatever prefix an application registers.
...
void main() {
  ...
  setUp(() {
    ...
    client = RelayClient(Dio()..httpClientAdapter = adapter, baseUrl: base);
  });
  ...
  test('both endpoints hang off that one base', () async {
    ...
    expect(adapter.requests.single.uri.toString(), '$base/report');
  });
